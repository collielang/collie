...
最后更新：2026-07-31（t87 完成：codegen byte/word 类字段——CGField.bit_max + register_class_layout 前置分支 i64 槽承载 + visitNew/visitPropertyAssign 两触点 check_bit_range 范围陷阱，差分 39/39）
