...
最后更新：2026-08-01（t97 完成：codegen byte/word 函数返回类型放行——declare_function 前置识别返回类型为 Int 承载 + CGFunction.ret_bit_max，visitReturn 插 check_bit_range 复用 t69 陷阱，byte/word 参数/类方法返回仍拒编，差分 49/49）
