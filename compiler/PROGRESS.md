...
最后更新：2026-07-30（t85 完成：codegen 嵌套数组——新增数组 kind 4（槽存内层数组 ptr 位模式），限两层且内层数值系，字面量/逐层索引读写/别名联动/整槽替换/深比较/print 递归转串全解锁，rt_arr_to_str/rt_arr_eq 加 kind 4 递归，差分 37/37）
